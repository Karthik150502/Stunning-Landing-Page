...
export default function dummy() {
    return (
        <section
            ...
            className='h-[492px] flex items-center overflow-hidden relative [mask-image:linear-gradient(to_bottom,transparent,black_10%,black_90%,transparent)]' style={{
            ...
            {/* Start Planet */}
            <div className="absolute h-64 w-64 bg-purple-500 rounded-full border-white/20 top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2
    ...
    "></div>
            ...
            <div
                ...
                className="reverse absolute w-[344px] h-[344px]  border rounded-full top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 opacity-20">
            ...
            <div
                ...
                className='w-[444px] h-[444px] absolute rounded-full top-1/2 left-1/2 border -translate-x-1/2 -translate-y-1/2 border-white/20  border-dashed'>
            </div>
            {/* End ring-2 */}

            {/* Start ring-3 */}
            <div className="absolute h-[544px] w-[544px] md:w-[980px] rounded-full border border-white top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 opacity-20">
